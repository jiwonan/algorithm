...
### 풀이요약
'-'를 한 번이라도 만나면 그 다음부터는 양수를 쭉 음수로 만들 수 있음.<br/>
괄호의 갯수는 정해져있지 않기 때문에 어디에도 칠 수 있음.<br/>
ex1) 10-0-0+1 => 10 - (0) - (0 + 1) => 10 - 0 - 0 - 1 => 9<br/>
ex2) 14-13+38-95 => 14 - (13 + 38) - 95 => 14 - 13 - 38 - 95 => -132<br/>
